...
const TABS = [
  { name: 'index',   title: 'Dashboard', icon: 'view-dashboard',        iconOutline: 'view-dashboard-outline' },
  { name: 'fleet',   title: 'My Fleet',  icon: 'car-multiple',          iconOutline: 'car-multiple' },
  { name: 'wallet',  title: 'Wallet',    icon: 'wallet',                iconOutline: 'wallet-outline' },
...
export default function HostTabsLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="fleet"   options={{ title: 'My Fleet'  }} />
